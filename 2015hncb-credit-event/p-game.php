...
session_start();
	...
	if ($_SESSION['curPage']=='p-game-01.php'){
...
<body onLoad="MM_preloadImages('images/btn-start-b.png','images/btn-01b.png','images/btn-02b.png','images/btn-03b.png','images/btn-04b.png','images/btn-05b.png')">
<?php include_once("analyticstracking.php") ?>
<?
	session_start();
	$_SESSION['PCard']=strval(rand(1,7));
...
<!--menu end-->
<!--tai-->
<div id="in-btn"><a href="prize.php"><a href="prize.php?par=<? echo $_SESSION['par']; ?>"><img src="images/small-pic.png" border="0" /></a></a></div>
<div id="in-btn-menu">
<ul>
...
<div id="in-w"><img src="images/word-01.png" /></div>
<!--tai end-->
<!--main-->
<div id="cards-pic"><img src="images/cards.png" width="913" height="679" /></div>
<div id="in-btn-go"><a href="#" onClick="gotoUrl('p-game-01.php');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','images/btn-05b.png',1)"><img src="images/btn-05.png" name="Image9" border="0" id="Image9" /></a></div>
<!--main end-->
</div>
<!--footer-->
