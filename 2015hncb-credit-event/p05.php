...
if(!isset($_SERVER['HTTP_REFERER'])|| $_SERVER['HTTP_REFERER'] =='')
			exit;
	$bAllow	=false;
	if ( strpos(strtolower($_SERVER['HTTP_REFERER']),'p04.php'))
		$bAllow	=true;
...
<table width="100%" height="100%" border="0" valign="center" align="center" cellpadding="0" cellspacing="0">
  
  <tr >
	<td width="28%">&nbsp;</td>
    <td width="25%"><img  onclick="javascript:location.href='loading.php'; " src="images/btn-again.png" /></td>
    <td width="25%"><img  onclick="javascript:alert('如視窗未關閉,請自行關閉視窗');open('about:blank', '_self').close();location.href='about:blank'; setTimeout (window.close, 500);" src="images/btn-out.png" /></td>
	<td width="22%">&nbsp;</td>
  </tr>
</table>
