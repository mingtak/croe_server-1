<?
echo '<form method="post" id="filterform" name="filterform" action="manageruser.php">';
...
echo '<label for="filtUserName" class="nofloat">UserName</label>';
echo '<input type="text" name="filtUserName" id="filtUserName" size="30" value="',$ae->filtUserName,'" />';
echo '<label for="filtCheckId" class="nofloat">CheckID</label>';
echo '<input type="text" name="filtCheckId" id="filtCheckId" size="30" value="',$ae->filtCheckId,'" />';
