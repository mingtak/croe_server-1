...
$urlExport=$_table . "_export.php?" . $_srchBar;
/******************************************************************/
// Sorting unit
/******************************************************************/
...
<div align="center"><center>
	...
	<?php echo $UI->Win('列表 - ' . $tagArray['pageName'])?>
		<table width="100%" cellspacing="0" cellpadding="0">
					...
					<table width="100%" height="30" bgcolor="#DEDEDE" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>
								...
								<input type="button" value="匯出搜尋之序號資料" onClick="location.href='<?php echo $urlExport?>';">
							</td>
							<td width="10"></td>
							<td width="10"></td>
							<td width="10"></td>
			...
			<tr>
				<td>
					<table width="100%" cellspacing="1" bgcolor="#9E9E9E" border="1">
						...
						<tr bgcolor="#FFFFFF" height="22" onMouseOver="TdColor(this,'#DEEEF3')" onMouseOut="TdColor(this,'#FFFFFF')">
							...
							foreach ($_listArray as $_listItem)
							{
								if ($_listItem ==$_table.'_SMSStat' && $dbArray[$_listItem] != '1' )
								{
									echo 	"<td><a>".  $dbArray[$_listItem] ."</a></td>";
								}else
