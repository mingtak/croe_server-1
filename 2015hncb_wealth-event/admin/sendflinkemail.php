...
//echo $bodyh; 
$DB->Select(DATABASE);
$dbQuery = $DB->Query("SELECT * FROM ". $t ." WHERE `2014hncb_app_lotteryCheck` =1 AND `2014hncb_app_lotterySent` =0 AND  `2014hncb_app_lotteryFriendPhone` IS NOT NULL AND NOT  `2014hncb_app_lotteryFriendPhone` =  '' AND   `2014hncb_app_lotteryFriendPhone` !=  `2014hncb_app_lotteryPhone` ;");
