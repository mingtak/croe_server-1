				...
				<td colspan="3">
					<table width="100%" height="30" bgcolor="#DEDEDE" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="10"></td>
							<td>
								<input type="button" value="匯出推薦人資料" onClick="location.href='<?php echo $_table?>_export.php';">
							</td>
							<td width="10"></td>
							<td>
							</td>
				...
				<td>
					<table width="100%" cellspacing="1" bgcolor="#9E9E9E">
						...
						<tr bgcolor="#FFFFFF" height="22" onMouseOver="TdColor(this,'#DEEEF3')" onMouseOut="TdColor(this,'#FFFFFF')">
							...
							{
							?>
							<td width="25" align="center"><img src="<?php echo IMAGES?>interface/edit1.gif" <?php echo ($_enableEdit) ? 'style="cursor: pointer" onClick="ModifyAct(1,\'' . $dbArray[$_table.'_fundID'] . '\')"' : 'style="filter: gray"' ?> alt="修改這筆資料"></td>
							<td width="25" align="center"><img src="<?php echo IMAGES?>interface/delete.gif" <?php echo ($_enableDelete) ? 'style="cursor: pointer" onClick="ModifyAct(2,\'' . $dbArray[$_table.'_fundID'] . '\')"' : 'style="filter: gray"' ?> alt="刪除這筆資料"></td>
							<td width="25" align="center"><img src="<?php echo IMAGES?>interface/view1.gif" <?php echo ($_enableView) ? 'style="cursor: pointer" onClick="ModifyAct(3,\'' . $dbArray[$_table.'_fundID'] . '\')"' : 'style="filter: gray"' ?> alt="瀏覽這筆資料的詳細內容"></td>
							<?php
							}
							else
							{
