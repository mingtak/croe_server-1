	...
	<?php echo $UI->Win('修改 - ' . $tagArray['pageName'])?>
		<table width="100%" cellspacing="0" cellpadding="0">
					...
					<table width="100%" cellspacing="1" bgcolor="#9E9E9E">
						...
						<input type="hidden" name="controlNo" value="<?php echo $_GET['controlNo']?>">
							...
							<td width="25%" bgcolor="#DEDEDE">
								<?php echo $_fieldData[$_table.'FB_ID']?>：
							</td>
							<td width="75%" bgcolor="#FFFFFF">
								<input type="text" name="<?php echo $_table?>FB_ID" maxlength="30" size="30" value="<?php echo $dbArray[$_table.'FB_ID']?>">
							</td>
						</tr>
            ...
            <tr height="25">
							...
							<td width="75%" bgcolor="#FFFFFF">
								<input type="text" name="<?php echo $_table?>Name" maxlength="30" size="30" value="<?php echo $dbArray[$_table.'Name']?>">
							</td>
						</tr>
            <tr height="25">
							<td width="25%" bgcolor="#DEDEDE">
							...
							<td width="75%" bgcolor="#FFFFFF">
								<input type="text" name="<?php echo $_table?>ID" maxlength="30" size="30" value="<?php echo $dbArray[$_table.'ID']?>">
							</td>
						</tr>
						...
						<tr height="25">
							...
							<td width="75%" bgcolor="#FFFFFF">
								<input type="text" name="<?php echo $_table?>Phone" maxlength="16" size="30" value="<?php echo $dbArray[$_table.'Phone']?>">
							</td>
						</tr>
						<tr height="25">
							<td width="25%" bgcolor="#DEDEDE">
							...
							<td width="75%" bgcolor="#FFFFFF">
								<input type="text" name="<?php echo $_table?>EMail" maxlength="50" size="30" value="<?php echo $dbArray[$_table.'EMail']?>">
							</td>
						</tr>
						<tr height="25">
							<td width="25%" bgcolor="#DEDEDE">
							...
							<td width="75%" bgcolor="#FFFFFF">
								<input type="text" name="<?php echo $_table?>Datetime" maxlength="16" size="30" value="<?php echo $dbArray[$_table.'Datetime']?>">
							</td>
						</tr>
						<tr height="25">
							<td width="25%" bgcolor="#DEDEDE">
							...
							<td width="75%" bgcolor="#FFFFFF">
								<input type="text" name="<?php echo $_table?>IPAddr" maxlength="16" size="30" value="<?php echo $dbArray[$_table.'IPAddr']?>">
							</td>
						</tr>						
						<tr height="35">
